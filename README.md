...
README собран как единый отчет по проекту на основе исходного ноутбука `powerconsumption.ipynb`, датасета `powerconsumption.csv` и ноутбука пайплайна задания №4 `task4_powerconsumption_pipeline.ipynb`.
...
- в задании №4 LightGBM показал лучший средний backtesting RMSE: 838.16;
